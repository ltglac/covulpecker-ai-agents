...
```
                        ...
                        └────────────┬──────────────┘
                                     ...
                                     ▼
                 ┌─────────────────────────────────────────┐
                 │  Security Researcher (Prosecutor Agent)  │
                 │------------------------------------------│
                 │ • Analyze source code for vulnerabilities │
                 │ • Output: JSON list of potential issues   │
                 └─────────────────────────────────────────┘
                                     │
                                     ▼
        ┌──────────────────────────────────────────────────────────────────┐
        │             Multi-round Discussion (k ≥ 1 rounds)                │
        │                                                                  │
        │   ┌──────────────────────┐        ┌──────────────────────┐       │
        │   │  Code Author Agent   │ <────> │  Moderator Agent     │       │
        │   │  (Defense Side)      │  chat  │  (Judge / Summarizer)│       │
        │   │----------------------│        │----------------------│       │
        │   │ • Refute / justify   │        │ • Summarize dialogue │       │
        │   │ • JSON reply (reason)│        │ • Neutral summary    │       │
        │   └──────────────────────┘        └──────────────────────┘       │
        │                                                                  │
        │  ↳ Security Researcher may review summaries and update findings  │
        └──────────────────────────────────────────────────────────────────┘
                                     │
                                     ▼
                 ┌──────────────────────────────────────────┐
                 │        Review Board (Jury Agent)         │
                 │-------------------------------------------│
                 │ • Review all discussion rounds            │
                 │ • Validate or reject each vulnerability   │
                 │ • Assign severity and final decision       │
                 └──────────────────────────────────────────┘
                                     │
                                     ▼
                        ┌───────────────────────────┐
